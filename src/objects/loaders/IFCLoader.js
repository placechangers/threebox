...
(function () {
    ...
    class IFCLoader extends THREE.Loader {
        ...
        /**
         * Loads and parses a IFC asset from a URL.
         *
         ...
         * Parses a IFC file.
         *
         * @param {String} text - Content of IFC file
    ...
    /**
     * Create a new IFCLoader.MaterialCreator
...
module.exports = exports = THREE.IFCLoader;
